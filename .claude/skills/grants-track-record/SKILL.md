...
## Applying this to Attesto

Attesto's live program is Colosseum's Crypto World's Fair (Solana
track + general tracks, submissions due 2026-10-12, winners announced
~2026-12-05 — verify these dates live before relying on them, per the
non-negotiables above, since this file itself can go stale). Run Steps
1-4 against Colosseum specifically (and any Solana-Foundation-run
program, if one becomes relevant) before treating any assumption about
"what usually wins" as settled — nothing has been researched here yet.
